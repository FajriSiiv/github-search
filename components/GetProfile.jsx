  ...
  return (
    <>
      <div className="grid grid-cols-8">
        <div className="h-20 w-20  relative col-span-3">
          <Image
        ...
        <div className="col-span-5 ">
          <div>
            <p className="text-sm font-bold tracking-[1px]">
              {name ? name : "Not Available"}
            </p>
            <p className="text-xs text-sky-400 my-1">
              {email ? email : "Not Available"}
            </p>
          </div>
          <p className="text-xs">{createAt ? createAt : "Joined"}</p>
        </div>
      </div>
      <div className="mt-3">
        <p className="text-sm leading-relaxed">{bio ? bio : "Dont Have Bio"}</p>
      </div>
      <div
        className={`grid grid-cols-3 bg-[#141C2F] px-2 py-4 text-xs my-3 rounded-lg text-white`}
      >
      ...
      <div className="my-5 flex flex-col gap-y-3">
        ...
        <div className={`flex gap-x-4 ${blog ? "" : "text-gray-300"}`}>
          ...
          <a href={blog ? blog : "#"} rel="norefferer" target="_blank">
            {blog ? "Website" : "Null"}
          </a>
        </div>
